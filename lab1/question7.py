# you live 4 miles from university. the bus driver at 25mph but spends 2 minutes at each of the 10 stops on the way. how long will the bus journey take? Alternatively, you could run to university. you jog the first mile at 7mph; then run the next two at 15mph; before jogging the last at 7mph again. will this be quicker or slower than the bus.
living_miles_apart = 4
drives_velocity = 25
time_taken = ((living_miles_apart / drives_velocity) * 60)
# 2 minutes in each stops
time_spends = 20
